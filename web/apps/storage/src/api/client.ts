...
export const api = {
	...
	setUserPassword: (userGuid: string, body: SetPasswordBody) => users.usersControllerV1SetPasswordV1(userGuid, body),
	...
	listBucketUsers: (bucketName: string) => buckets.bucketsControllerV1ListUsersV1(bucketName),
